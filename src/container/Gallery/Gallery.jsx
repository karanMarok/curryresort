  ...
  return (
    <div className="app__gallery flex__center">
      <div className="app__gallery-content">
        ...
        <h1 className="headtext__cormorant" style={{color: "#7D0202"}}>Photo Gallery</h1>
        <p
        ...
        <button type="button" className="custom__button" style={{color: "white", backgroundColor: "#7D0202"}}>
          View More
        </button>
      </div>
